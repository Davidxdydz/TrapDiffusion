...
srun --ntasks=1 python create_dataset.py --preset SOSI_fixed --quiet &
srun --ntasks=1 python create_dataset.py --preset SOSI_random --quiet &
srun --ntasks=1 python create_dataset.py --preset MOMI_fixed --quiet &
wait
deactivate
